...
function teste(s: string): Integer;
var List: TStringList;
    dummy:Integer;
    resultat: tirage;
    maxred,maxgreen,maxblue:Integer;
...
begin
  ...
  begin
    ...
    if maxred<resultat.red then maxred:=resultat.red;
    if maxgreen<resultat.green then maxgreen:=resultat.green;
    if maxblue<resultat.blue then maxblue:=resultat.blue;
  end;
  teste:=maxred*maxblue*maxgreen;
  List.Free;
end;
