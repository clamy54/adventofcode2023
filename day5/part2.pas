...
type map=record
          source, destination, size : qword;
     end;
           
var
  myFile : TextFile;
  seeds: array of QWord;
  ...
  boucle, posindex: Integer;
  valueseed,valuesoil,valuefertilizer,valuewater,valuelight,valuetemperature,valuehumidity,valuelocation,minlocation: QWord;
...
function getlocationfromhumidity(n: qword):qword;
var output: qword;
    t: integer;
begin
 output:=n;
...
function gethumidityfromtemperature(n: qword):qword;
var output: qword;
    t: integer;
begin
 output:=n;
...
function gettemperaturefromlight(n: qword):qword;
var output: qword;
    t: integer;
begin
 output:=n;
...
function getlightfromwater(n: qword):qword;
var output: qword;
    t: integer;
begin
 output:=n;
...
function getwaterfromfertilizer(n: qword):qword;
var output: qword;
    t: integer;
begin
 output:=n;
...
function getfertilizerfromsoil(n: qword):qword;
var output: qword;
    t: integer;
begin
 output:=n;
...
function getsoilfromseed(n: qword):qword;
var output: qword;
    t: integer;
begin
 output:=n;
...
begin
  ...
  writeln('searching for range : '+IntToStr(seeds[posindex])+' to '+IntToStr((seeds[posindex]+seeds[posindex+1]-1)));  
  for boucle:=seeds[posindex] to (seeds[posindex]+seeds[posindex+1]-1) do
    begin
      valueseed:=boucle;
